...
public class AuthService {
    ...
    public String addUser(String username, String password, String email, int regionNumber, Model model) {
        ...
        if (errorMessage != null) {
            return registrationFailure(model, errorMessage);
        }
        ...
        if (userRole.isPresent()) {
            ...
            return registrationFailure(model, "Извините, у нас возникла ошибка, попробуйте позже. Скоро мы все исправим.");
        }
    }
    ...
    public String registrationFailure(Model model, String errorMessage) {
